...
import { JsonlintService } from './Jsonlint.service';

declareProviders([JsonlintService]);

const service = useService(JsonlintService);
</script>
  ...
  <div class="px-6 py-10">
    ...
    <div ref="container" class="flex w-full flex-col lg:flex-row">
      ...
      <div class="divider h-12 lg:divider-horizontal lg:h-auto lg:w-16">
        ...
        <button class="btn btn-primary" @click="service.handleEval">
          Eval
        </button>
